...
write.xlsx(data_go,"C:/Users/Anna/Documents/CVID_project/GSEA/ActBright_CVIDxHD/GO.xlsx", asTable = TRUE, rowNames=FALSE)
...
p <- as.data.frame(gse) %>%
  ...
  ylab(NULL) +
  ggtitle("GO: Activated Bright CVID x HD")
...
p <- as.data.frame(gse) %>%
  ...
  scale_fill_continuous(low='red', high='blue', guide=guide_colorbar(reverse=TRUE)) + 
  ylab(NULL) +
  ggtitle("GO: Activated Memory CVID x HD")
...
write.xlsx(data_kegg,"C:/Users/Anna/Documents/CVID_project/GSEA/ActBright_CVIDxHD/KEGG.xlsx", asTable = TRUE, rowNames=FALSE)
...
p <- as.data.frame(kk2) %>%
  ...
  scale_fill_continuous(low='red', high='blue', guide=guide_colorbar(reverse=TRUE)) + 
  ylab(NULL) +
  ggtitle("KEGG: Activated Bright CVID x HD")
...
dme <- pathview(gene.data=entrez_geneList, pathway.id="hsa05022", species = kegg_organism)
...
write.xlsx(data_react,"C:/Users/Anna/Documents/CVID_project/GSEA/ActBright_CVIDxHD/Reactome.xlsx", asTable = TRUE, rowNames=FALSE)
?gsePathway
p <- as.data.frame(react) %>%
  ...
  scale_fill_continuous(low='red', high='blue', guide=guide_colorbar(reverse=TRUE)) + 
  ylab(NULL) +
  ggtitle("Reactome: Activated Memory CVID x HD")
...
p <- as.data.frame(react) %>%
  ...
  scale_fill_continuous(low='red', high='blue', guide=guide_colorbar(reverse=TRUE)) + 
  ylab(NULL) +
  ggtitle("Reactome: Activated Bright CVID x HD")
...
write.xlsx(data_do,"C:/Users/Anna/Documents/CVID_project/GSEA/ActBright_CVIDxHD/DO.xlsx", asTable = TRUE, rowNames=FALSE)
?gseDO
p <- as.data.frame(do) %>%
  mutate(
    num_genes = sapply(strsplit(core_enrichment, "/"), length),
  ...
  scale_fill_continuous(low='red', high='blue', guide=guide_colorbar(reverse=TRUE)) + 
  ylab(NULL) +
  ggtitle("DO: Activated Bright CVID x HD")
#barplot
p <- as.data.frame(do) %>%
  dplyr::arrange(p.adjust) %>% 
  dplyr::group_by(sign(NES)) %>% 
...
write.xlsx(data_em2,"C:/Users/Anna/Documents/CVID_project/GSEA/ActBright_CVIDxHD/Motifs.xlsx", asTable = TRUE, rowNames=FALSE)
...
p <- as.data.frame(em2) %>%
  ...
  scale_fill_continuous(low='red', high='blue', guide=guide_colorbar(reverse=TRUE)) + 
  ylab(NULL) +
  ggtitle("Regulatory gene sets: Activated Memory CVID x HD")
...
write.xlsx(data_em3,"C:/Users/Anna/Documents/CVID_project/GSEA/ActBright_CVIDxHD/Signatures.xlsx", asTable = TRUE, rowNames=FALSE)
...
p <- as.data.frame(em3) %>%
  ...
  scale_fill_continuous(low='red', high='blue', guide=guide_colorbar(reverse=TRUE)) + 
  ylab(NULL) +
  ggtitle("Signatures: Activated Bright CVID x HD")
...
write.xlsx(data_em4,"C:/Users/Anna/Documents/CVID_project/GSEA/ActBright_CVIDxHD/Hallmarks.xlsx", asTable = TRUE, rowNames=FALSE)
...
p <- as.data.frame(em4) %>%
  ...
  scale_fill_continuous(low='red', high='blue', guide=guide_colorbar(reverse=TRUE)) + 
  ylab(NULL) +
  ggtitle("Hallmark pathways: Activated Memory CVID x HD")
