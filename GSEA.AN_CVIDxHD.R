...
df <-read.xlsx("C:/Users/Anna/Documents/CVID_project/DF/df.AN_CVIDxHD.xlsx", rowNames=FALSE)
# log2 fold change 
...
write.xlsx(data_go,"C:/Users/Anna/Documents/CVID_project/GSEA/ActNaive_CVIDxHD/GO.xlsx", asTable = TRUE, rowNames=TRUE)
...
p <- as.data.frame(gse) %>%
  ...
  ylab(NULL) +
  ggtitle("GO: Activated Naïve CVID x HD")
...
write.xlsx(data_kegg,"C:/Users/Anna/Documents/CVID_project/GSEA/ActNaive_CVIDxHD/KEGG.xlsx", asTable = TRUE, rowNames=TRUE)
...
p <- as.data.frame(kk2) %>%
  ...
  scale_fill_continuous(low='red', high='blue', guide=guide_colorbar(reverse=TRUE)) + 
  ylab(NULL) +
  ggtitle("KEGG: Activated Naïve CVID x HD")
...
dme <- pathview(gene.data=entrez_geneList, pathway.id="hsa04613", species = kegg_organism)
...
write.xlsx(data_react,"C:/Users/Anna/Documents/CVID_project/GSEA/ActNaive_CVIDxHD/Reactome.xlsx", asTable = TRUE, rowNames=FALSE)
?gsePathway
p <- as.data.frame(react) %>%
  ...
  scale_fill_continuous(low='red', high='blue', guide=guide_colorbar(reverse=TRUE)) + 
  ylab(NULL) +
  ggtitle("Reactome: Activated Naïve CVID x HD")
#upsetplot
upsetplot(react)
...
write.xlsx(data_do,"C:/Users/Anna/Documents/CVID_project/GSEA/ActNaive_CVIDxHD/DO.xlsx", asTable = TRUE, rowNames=FALSE)
...
p <- as.data.frame(do) %>%
  ...
  scale_fill_continuous(low='red', high='blue', guide=guide_colorbar(reverse=TRUE)) + 
  ylab(NULL) +
  ggtitle("DO: Activated Naïve CVID x HD")
#barplot
p <- as.data.frame(do) %>%
  dplyr::arrange(p.adjust) %>% 
  dplyr::group_by(sign(NES)) %>% 
...
write.xlsx(data_em2,"C:/Users/Anna/Documents/CVID_project/GSEA/ActNaive_CVIDxHD/Motifs.xlsx", asTable = TRUE, rowNames=FALSE)
...
p <- as.data.frame(em2) %>%
  ...
  scale_fill_continuous(low='red', high='blue', guide=guide_colorbar(reverse=TRUE)) + 
  ylab(NULL) +
  ggtitle("Regulatory gene sets: Activated Naïve CVID x HD")

em2_top20 <- as.data.frame(em2) %>%
  dplyr::arrange(p.adjust) %>% 
  dplyr::group_by(sign(NES)) %>% 
  dplyr::slice(1:20)
write.xlsx(em2_top20,"C:/Users/Anna/Documents/CVID_project/GSEA/ActNaive_CVIDxHD/top36_regulatory.xlsx", asTable = TRUE, rowNames=FALSE)
...
write.xlsx(data_em3,"C:/Users/Anna/Documents/CVID_project/GSEA/ActNaive_CVIDxHD/Signatures.xlsx", asTable = TRUE, rowNames=FALSE)
...
write.xlsx(data_em4,"C:/Users/Anna/Documents/CVID_project/GSEA/ActNaive_CVIDxHD/Hallmarks.xlsx", asTable = TRUE, rowNames=FALSE)
...
p <- as.data.frame(em4) %>%
  ...
  scale_fill_continuous(low='red', high='blue', guide=guide_colorbar(reverse=TRUE)) + 
  ylab(NULL) +
  ggtitle("Hallmark pathways: Activated Naïve CVID x HD")
