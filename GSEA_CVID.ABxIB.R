...
df <-read.xlsx("C:/Users/Anna/Documents/CVID_project/DF/df.CVID_ABxIB.xlsx", rowNames=FALSE)
# log2 fold change 
...
write.xlsx(data_go,"C:/Users/Anna/Documents/CVID_project/GSEA/CVID_ABxIB/GO.xlsx", asTable = TRUE, rowNames=TRUE)
...
p <- as.data.frame(gse) %>%
  ...
  ylab(NULL) +
  ggtitle("GO: CVID Bright Activated x Nonactivated")
...
emapplot(pwt,showCategory=10) +
  ggtitle("CVID Bright Activated x Nonactivated")+
...
write.xlsx(data_kegg,"C:/Users/Anna/Documents/CVID_project/GSEA/CVID_ABxIB/KEGG.xlsx", asTable = TRUE, rowNames=TRUE)
...
p <- as.data.frame(kk2) %>%
  ...
  scale_fill_continuous(low='red', high='blue', guide=guide_colorbar(reverse=TRUE)) + 
  ylab(NULL) +
  ggtitle("KEGG: CVID Bright Activated x Nonactivated")
...
#running score
plot<- gseaplot(kk2, geneSetID = 1, by = "runningScore", title = "KEGG: CVID Bright Activated x Nonactivated")
#pathview
library(pathview)
...
write.xlsx(data_react,"C:/Users/Anna/Documents/CVID_project/GSEA/CVID_ABxIB/Reactome.xlsx", asTable = TRUE, rowNames=FALSE)
...
p <- as.data.frame(react) %>%
  ...
  scale_fill_continuous(low='red', high='blue', guide=guide_colorbar(reverse=TRUE)) + 
  ylab(NULL) +
  ggtitle("Reactome: CVID Bright Activated x Nonactivated")
#upsetplot
upsetplot(react)
##DOSE
set.seed(123)
...
write.xlsx(data_do,"C:/Users/Anna/Documents/CVID_project/GSEA/CVID_ABxIB/DO.xlsx", asTable = TRUE, rowNames=FALSE)
p <- as.data.frame(do) %>%
  mutate(
    num_genes = sapply(strsplit(core_enrichment, "/"), length),
    GeneRatio = num_genes / setSize) %>%
  ...
  scale_fill_continuous(low='red', high='blue', guide=guide_colorbar(reverse=TRUE)) + 
  ylab(NULL) +
  ggtitle("DO: CVID Bright Activated x Nonactivated")
#barplot
p <- as.data.frame(do) %>%
  dplyr::arrange(p.adjust) %>% 
  dplyr::group_by(sign(NES)) %>% 
...
write.xlsx(data_em2,"C:/Users/Anna/Documents/CVID_project/GSEA/CVID_ABxIB/Motifs.xlsx", asTable = TRUE, rowNames=FALSE)
...
p <- as.data.frame(em2) %>%
  ...
  scale_fill_continuous(low='red', high='blue', guide=guide_colorbar(reverse=TRUE)) + 
  ylab(NULL) +
  ggtitle("Motifs: CVID Bright Activated x Nonactivated")
...
write.xlsx(data_em3,"C:/Users/Anna/Documents/CVID_project/GSEA/CVID_ABxIB/Signatures.xlsx", asTable = TRUE, rowNames=FALSE)
...
p <- as.data.frame(em3) %>%
  ...
  scale_fill_continuous(low='red', high='blue', guide=guide_colorbar(reverse=TRUE)) + 
  ylab(NULL) +
  ggtitle("Signatures: CVID Bright Activated x Nonactivated")
...
write.xlsx(data_em4,"C:/Users/Anna/Documents/CVID_project/GSEA/CVID_ABxIB/Hallmarks.xlsx", asTable = TRUE, rowNames=FALSE)
...
p <- as.data.frame(em4) %>%
  ...
  scale_fill_continuous(low='red', high='blue', guide=guide_colorbar(reverse=TRUE)) + 
  ylab(NULL) +
  ggtitle("Hallmark pathways: CVID Bright Activated x Nonactivated")
